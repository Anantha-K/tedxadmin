...
const PresentCandidates = () => {
  ...
  const [showPresentSection, setShowPresentSection] = useState(false);
  ...
  const togglePresentSection = () => {
    if (!showPresentSection) {
      fetchPresentCandidates();
    }
    setShowPresentSection(!showPresentSection);
  };
  ...
  return (
    <div className="present-section">
      ...
      >
        <CheckCircle />
        {showPresentSection ? "Hide Present Candidates" : "Show Present Candidates"}
        {count > 0 && showPresentSection && <span className="count-badge" style={{
